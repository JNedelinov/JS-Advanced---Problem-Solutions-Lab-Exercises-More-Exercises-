function solveClasses() {
    class Pet {
        ...
        toString() {
            ...
            if (this.comments.length > 0) {
                arr.push(`Special requirements: ${this.comments.join(', ')}`);
            }
    ...
    class Cat extends Pet {
        ...
        toString() {
            ...
            let arr = [];
            arr.push('Main information:', `${this.name} is a cat with ${this.insideHabits}`);
            string += arr.join('\n');
    ...
    class Dog extends Pet {
        ...
        toString() {
            ...
            let arr = [];
            arr.push('Main information:', `${this.name} is a dog with need of ${this.runningNeeds}km running every day and ${this.trainability} trainability.`);
            string += arr.join('\n');
